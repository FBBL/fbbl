...
//  u64 totalNumInitialSamples = 30000;
    ...
    char convertedFolderName[256], sortedFolderName[256], challengeFileName[256];
    sprintf(challengeFileName, "%s/LWE_40_005.txt", LOCAL_SIMULATION_DIRECTORY_PATH_PREFIX_A);//, n, q, alpha);
    sprintf(convertedFolderName, "%s/tu_darmstadt_%d_%d_%f_converted", LOCAL_SIMULATION_DIRECTORY_PATH_PREFIX_A, n, q, alpha);
