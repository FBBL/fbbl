...
#define ZERO_COORDINATES 18

#define NUM_LMZ_STEPS 6
...
//  int q = 101;
    ...
    // n = 45, q=2027 alpha = 0.005, 7 plainBKW + 6 smoothLMS
    ...
    int unnatural_selection_ts[NUM_REDUCTION_STEPS] =         {0,    0,   0,   0,   0,   0,   0,       5,  10,   16,   27,   35,   20};
