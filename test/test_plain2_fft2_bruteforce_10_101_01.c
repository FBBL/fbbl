...
//  u64 totalNumInitialSamples = 10000;
    ...
    sprintf(outputfolder, "%s/test_plain2_fft2_bruteforce_10_101_01", LOCAL_SIMULATION_DIRECTORY_PATH_PREFIX_A);
    ...
    for (int i=0; i<numReductionSteps+1; i++)
    {
        ...
        int ret = solve_fft_search_hybrid(srcFolderName, solution, numSolvedCoordinates, numSolvablePositions, 1, FFT_SOLVER_DOUBLE_PRECISION);
