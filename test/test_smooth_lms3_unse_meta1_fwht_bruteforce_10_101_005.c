...
//  u64 totalNumInitialSamples = 1000000; /* 1 million */
    ...
    sprintf(outputfolder, "%s/test_smooth_lms3_unse_meta1_fwht_bruteforce_10_101_005", LOCAL_SIMULATION_DIRECTORY_PATH_PREFIX_A);
    ...
    bkwStepPar[NUM_REDUCTION_STEPS-2].sortingPar.smoothLMS.unnatural_selection_ts = 18;
    bkwStepPar[NUM_REDUCTION_STEPS-2].sortingPar.smoothLMS.unnatural_selection_start_index = 0;
    bkwStepPar[NUM_REDUCTION_STEPS-1].sortingPar.smoothLMS.unnatural_selection_ts = 18;
